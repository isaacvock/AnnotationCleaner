...
def get_target_input():
    ...
    target.append(expand("results/quantify_reference_fc/{SID}_exonbin.featureCounts", SID = SAMP_NAMES))
    target.append(expand("results/quantify_reference_fc/{SID}_intronbin.featureCounts", SID = SAMP_NAMES))
